...
describe("Pagination tests", () => {
  ...
  test("previous arrow should call onChange", () => {
    ...
    render(
      <Pagination pageCount={pageCount} range={range} forcePage={forcePage} onChange={onChange} />
    );

    const arrowPrevious = screen.getByTestId("previous-arrow");
  ...
  test("next arrow should call onChange", () => {
    ...
    const arrowNext = screen.getByTestId("next-arrow");
